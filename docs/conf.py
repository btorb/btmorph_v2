# -*- coding: utf-8 -*-
#
# btmorph documentation build configuration file, created by
# sphinx-quickstart2 on Tue Jan 21 12:07:58 2014.
#
...
project = u'btmorph v2'
copyright = u'2016, Ben Torben-Nielsen'
...
modindex_common_prefix = ['btmorph2']
...
latex_documents = [
  ('index', 'btmorph.tex', u'btmorph Documentation',
   u'Ben Torben-Nielsen', 'manual'),
]
...
man_pages = [
    ('index', 'btmorph', u'btmorph Documentation',
     [u'Ben Torben-Nielsen'], 1)
]
...
texinfo_documents = [
  ('index', 'btmorph', u'btmorph Documentation',
   u'Ben Torben-Nielsen', 'btmorph', 'One line description of project.',
   'Miscellaneous'),
]
